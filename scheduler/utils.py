...
from policies import allox, fifo, finish_time_fairness, gandiva, isolated, \
    ...
    min_total_duration, shared_cloud_cost_fairness
...
def get_policy(policy_name, solver=None, seed=None,
    ...
    elif policy_name == 'shared_cloud_cost_fairness':
        policy = shared_cloud_cost_fairness.SharedCloudCostFairnessPolicy(solver=solver)
    else:
